    ...
    return (<PageView>
        <Article>
            ...
            <section>
                ...
                <CodeBlock jsx>{code.code1}</CodeBlock>
                <p>
                ...
                <CodeBlock jsx>{code.code4}</CodeBlock>
                <p>
                ...
                <CodeBlock jsx>{code.code6}</CodeBlock>
            </section>
            ...
            <section>
                ...
                <CodeBlock jsx>{code.code7}</CodeBlock>
                <p>
                ...
                <CodeBlock jsx>{code.code7_1}</CodeBlock>
                <p>
                ...
                <CodeBlock jsx>{code.code7_2}</CodeBlock>
                <p>
                ...
                <CodeBlock jsx>{code.code8}</CodeBlock>
                <p>
                    And with that fully reusable hook for all get requests we may do we can rewrite our original hook,
                    that now looks quite clean. Use holidays? well that is the url, just delegate to the next hook
                    manage
                    that.
                </p>
                <CodeBlock jsx>{code.code8_1}</CodeBlock>
                <p>
                ...
                <p>
                    ...
                    via an auth token provided by a custom hook), and well, whatever we may need. A complete, yet
                    complex,
                    example is the useAxios hook from Axios library. Check the source code <a target="_blank"
                                                                                              href="https://github.com/simoneb/axios-hooks/blob/master/src/index.js">
                    here</a>.
                </p>
            </section>
            <section>
